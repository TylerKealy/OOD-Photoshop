...
/**
 * Class that can add a given value to each pixel in the image, darkening it.
 */
public class Darken implements PixelTransformation {
  private int value;

  /**
   * Creates a new Darken to transform it.
   *
